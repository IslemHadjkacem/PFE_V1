...
import { ParametrageModule } from './pages/parametrage/parametrage.module';
...
import { DeconnexionComponent } from './pages/se-connecter/deconnexion/deconnexion.component';
...
@NgModule({
    ...
    providers: [
        ...
        PhotoService, MenuService, BreadcrumbService, ConfigService
    ],
